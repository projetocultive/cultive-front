    ...
    <>
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-4 py-12">
        <div className="w-full text-center pb-8">
          ...
          <h1 className="font-bold text-3xl md:text-4xl lg:text-5xl font-heading text-teal-900 pb-2">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-gray-100 rounded-lg p-6">
            <div className="flex items-center space-x-6 mb-4">
              ...
              <div>
                ...
                <p className="text-base text-teal-600 font-normal ">
                  Desenvolvedora Jr.
                </p>
              </div>
            </div>
          ...
          <div className="bg-gray-100 rounded-lg p-6">
            <div className="flex items-center space-x-6 mb-4">
              ...
              />
              <div>
                <p className="text-xl text-gray-700 font-normal mb-1">Gabi</p>
                <p className="text-base text-teal-600 font-normal">
                  Desenvolvedora Jr.
                </p>
              </div>
          ...
          <div className="bg-gray-100 rounded-lg p-6">
            <div className="flex items-center space-x-6 mb-4">
              ...
              />
              <div>
                <p className="text-xl text-gray-700 font-normal mb-1">Nathan</p>
                <p className="text-base text-teal-600 font-normal">
                  Desenvolvedor Jr.
                </p>
              </div>
            ...
            <div>
              <p className="text-gray-400 leading-loose font-normal text-base">
                Nutricionista em transição para Dev Fullstack, trazendo
                habilidades em resolução de problemas e organização. Com
                participação ativa no Bootcamp da Generation Brasil 2024, pronta
                para contribuir em um ambiente dinâmico de tecnologia.
              </p>
            </div>
          </div>
          ...
          <div className="bg-gray-100 rounded-lg p-6">
            <div className="flex items-center space-x-6 mb-4">
              ...
              />
              <div>
                <p className="text-xl text-gray-700 font-normal mb-1">Sara</p>
                <p className="text-base text-teal-600 font-normal">
                  Desenvolvedora Jr.
                </p>
              </div>
            ...
            <div>
              <p className="text-gray-400 leading-loose font-normal text-base">
                Graduanda em Ciência de Dados, formada em psicologia. Estou em
                transição de carreira. Participei de 3 bootcamps: Java FullStack
                da Generation Brazil (2024), AWS da Escola da Nuvem (2023) e Big
                Data Engineer da Semantix (2023). Tenho inglês fluente e
          ...
          <div className="bg-gray-100 rounded-lg p-6">
            <div className="flex items-center space-x-6 mb-4">
              ...
              />
              <div>
                <p className="text-xl text-gray-700 font-normal mb-1">Thayná</p>
                <p className="text-base text-teal-600 font-normal">
                  Desenvolvedora Jr.
                </p>
              </div>
